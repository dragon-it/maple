...
const allPeriodGroups = [
  {
    ...
    bosses: [
      ...
      boss({
        ...
        bossName: "스우",
        icon: LotusIcon,
        difficulties: [normal(16700000), hard(51500000), extreme(574000000, 2)],
      }),
      boss({
        id: "damien",
        bossName: "데미안",
        icon: DamienIcon,
        difficulties: [normal(17500000), hard(48900000)],
      }),
      boss({
        id: "guardian_angel_slime",
        bossName: "가디언 엔젤 슬라임",
        icon: GuardianAngelSlimeIcon,
        difficulties: [normal(25500000), chaos(75100000)],
      }),
      boss({
        id: "lucid",
        bossName: "루시드",
      ...
      boss({
        ...
        bossName: "더스크",
        icon: DuskIcon,
        difficulties: [normal(44000000), chaos(69800000)],
      }),
      boss({
        id: "verus_hilla",
        bossName: "진 힐라",
      ...
      boss({
        ...
        bossName: "듄켈",
        icon: DunkelIcon,
        difficulties: [normal(47500000), hard(94400000)],
      }),
      boss({
        id: "chosen_seren",
        bossName: "선택받은 세렌",
  ...
  },
  {
    ...
    bosses: [
      boss({
        ...
        bossName: "검은 마법사",
        icon: BlackMageIcon,
        difficulties: [hard(665000000), extreme(8740000000)],
      }),
    ],
  },
];
